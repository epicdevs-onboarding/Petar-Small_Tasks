...
namespace Task4_Battleships.GameElements.Players
{
    internal class BotPlayer : Player, IPlayer
    {
        ...
        public void PlaceSingleShip(Ship ship, Tuple<int, int> coordinates, bool isVertical) // same as human player
        {
        ...
        public void PlacingShipsPhase() // same as human player
        {
        ...
        public void Strike(IPlayer opponent) // same as human player
        {
            bool isHit = false;
            bool isMiss = true;
            bool isSink = false;
